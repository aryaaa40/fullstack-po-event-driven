...
export default function CreatePOContent() {
  const { form, setField, submit, loading, error, amountValue } = useCreatePO();
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  placeholder="Briefly explain the purpose and business justification for this purchase..."
                  rows={5}
      ...
      {showModal && (
        ...
        >
          <div
            ...
            style={{
              backgroundColor: "#ffffff",
              boxShadow: "0 20px 40px rgba(42,52,57,0.12)",
            }}
